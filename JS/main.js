...
function dataFetch(fn) {
  fetch("../data.json")
    .then((result) => result.json())
    .then((response) => fn(response));
}

const render = (dataResult) => {
  dataResult.forEach((producto) => {
    ...
    boton.addEventListener("click", () => {
      agregarAlCarrito(producto.id, dataResult);
    });
  });
};
//pinto cards
...
const agregarAlCarrito = (prodId, stockProductos) => {
